  ...
  <NuxtLayout>
    ...
    <div class="flex flex-col w-full items-center my-10 gap-8">
      ...
      <form class="flex flex-col gap-8 w-full items-center ">
        ...
        <input v-model="A.firstName" type="text" class="input-auth w-1/4 sm:w-2/4" placeholder="Prénom" />
        <input v-model="A.lastName" type="text" class="input-auth w-1/4 sm:w-2/4" placeholder="Nom" />
        <input v-model="A.newPassword" type="text" class="input-auth w-1/4 sm:w-2/4" placeholder="Nouveau mot de passe (optionnel)"/>
        <label class="text-center mx-2">Veuillez confirmer votre mot de passe pour effectuer les changements ci-dessous :</label>
        <input v-model="A.password" type="password" class="input-auth w-1/4 sm:w-2/4" placeholder="Mot de passe"/>
